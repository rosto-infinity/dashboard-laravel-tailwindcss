    ...
    <div class="py-12">
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              <!-- ====== Chart One Start -->
              @include('profile.partials.chart-01')

              <!-- ====== Chart One End -->

              <!-- ====== Chart Two Start -->
              @include('profile.partials.chart-02')

              <!-- ====== Chart Two End -->

              <!-- ====== Chart Three Start -->
              @include('profile.partials.chart-03')

              <!-- ====== Chart Three End -->

              <!-- ====== Map One Start -->
              @include('profile.partials.map-01')
              ...
              <div class="col-span-12 xl:col-span-8">
                 <!-- ====== Map One Start -->
              @include('profile.partials.table-01')
                ...
                <div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{asset('images/user/user-03.png')}}" alt="User2" />
                      <span
